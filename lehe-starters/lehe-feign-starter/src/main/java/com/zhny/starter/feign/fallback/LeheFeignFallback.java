...
@Slf4j
@AllArgsConstructor
public class LeheFeignFallback<T> implements MethodInterceptor {
    ...
    public Object intercept(Object o, Method method, Object[] objects, MethodProxy methodProxy) throws Throwable {
        ...
        if (!(cause instanceof FeignException)) {
            return Result.fail(ResultEnum.FEIGN_ERROR, errorMessage);
        }
        FeignException exception = (FeignException) cause;
        byte[] content = exception.content();
        // 如果返回的数据为空
        if (ObjectUtils.isEmpty(content)) {
            return Result.fail(ResultEnum.FEIGN_CONTENT_EMPTY, errorMessage);
        }
    ...
    public boolean equals(Object o) {
        ...
        LeheFeignFallback<?> that = (LeheFeignFallback<?>) o;
