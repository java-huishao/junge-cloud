...
public class MinioUtil {
     ...
     */
    @SneakyThrows
    public void putObject(String bucketName, InputStream inputStream, String contentType, Long objectSize, String filename) {
    ...
    public void downloadFile(String bucketName, String fileName, String originalName, OutputStream outputStream) {
        try {
