package com.zhny.starter.log.enums;
...
public enum ActionEnum {
    ...
    UNBINDING(39, "解绑"),
    NULL(0, "null"),
    DISABLEADMINACCOUNT(100, "禁用了内部账户");

    private final int type;
    private final String name;

    ActionEnum(int type, String name) {
        this.type = type;
        this.name = name;
    }

    public static ActionEnum parse(int type) {
        for (ActionEnum Enum : ActionEnum.values()) {
